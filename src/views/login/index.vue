<template lang="">
    <div class="login w-full h-full ">
        <div class="fixed top-1/2 scale-80 w-[400px] left-1/2 -translate-x-1/2 flex flex-col gap-8 -translate-y-1/2  px-10 py-10 rounded-md shadow-md animate__pulse animate__animated">
